...
|------------|-----------|
| ![Front](https://github.com/owner/monitor-mount/releases/latest/download/monitor-mount_front.png) | ![Rear](https://github.com/owner/monitor-mount/releases/latest/download/monitor-mount_rear.png) |
...
**Download STL**: [monitor-mount.stl](https://github.com/owner/monitor-mount/releases/latest/download/monitor-mount.stl)
